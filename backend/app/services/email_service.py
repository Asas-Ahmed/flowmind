        ...
        ">
          ...
          <div style="padding: 32px 28px;">
            ...
            <p style="
              ...
              color: #475569;
            ">
              Welcome to FlowMind. Please verify that this email address
              belongs to you before signing in.
            </p>
            ...
            ">
              ...
              {settings.EMAIL_VERIFICATION_TOKEN_EXPIRE_MINUTES} minutes.
            </p>
            ...
            <p style="
              ...
              color: #64748b;
            ">
              If you did not create a FlowMind account, you can safely
              ignore this email.
            </p>
        ...
        resend.Emails.send(
            {
                "from": settings.EMAIL_FROM,
                "to": [recipient_email],
                "subject": "Verify your FlowMind email",
                "html": email_html,
            }
        )
    except Exception:
